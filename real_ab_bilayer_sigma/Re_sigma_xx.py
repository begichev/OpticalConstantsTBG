...
def calc_optical_conductivity(omegas=np.arange(0.05, 2, 0.05), gamma=0.002*t, e_win=0.02*t, save_to='bilayer_sigma_10_0.02_gamma0.002_ewin0.02n21_changev.txt'):
    vals = np.loadtxt("real_bilayer_energies_10_0.02.txt", dtype=float)
    vecs = np.loadtxt("real_bilayer_wavefunctions_10_0.02.txt", dtype=complex)
